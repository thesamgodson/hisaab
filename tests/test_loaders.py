...
class TestMGNREGAMisappropriation:
    def test_round_trip(self, db):
        records = [{
            ...
            "cases_reported": 12, "amount_reported": 45.5,
            "cases_decided": 8, "amount_decided": 30.0,
            "cases_pending_recovery": 4, "amount_to_recover": 15.5,
            "cases_recovered": 3, "amount_recovered": 10.0,
            "amount_unrecovered": 5.5, "recovery_rate_pct": 64.5,
            "source_url": "nrega.nic.in", "scraped_at": "2026-01-01T00:00:00",
        }]
...
class TestMGNREGAFTOStatus:
    def test_round_trip(self, db):
        records = [{
            "district": "PATNA", "state": "BIHAR", "state_code": "05",
            "total_fto_generated": 500, "first_signatory_signed": 450,
            "first_signatory_pending": 50, "second_signatory_signed": 400,
            "second_signatory_pending": 100, "fto_sent_to_bank": 380,
            "fto_processed_by_bank": 350, "transactions_processed": 9000,
            "source_url": "nrega.nic.in", "scraped_at": "2026-01-01T00:00:00",
        }]
...
class TestMGNREGAFTOPendency:
    def test_round_trip(self, db):
        records = [{
            "bank_name": "SBI", "is_total": False,
            "state": "BIHAR", "state_code": "05",
            "pending_1_7_days": 10, "pending_8_15_days": 20,
            "pending_16_30_days": 5, "pending_over_30_days": 3,
            "total_pending": 38,
            "source_url": "nrega.nic.in", "scraped_at": "2026-01-01T00:00:00",
        }]
...
class TestMGNREGAIssuesReported:
    def test_round_trip(self, db):
        records = [{
            "district": "PATNA", "state": "BIHAR", "state_code": "05",
            "total_gps": 200, "gps_audited": 150,
            "misappropriation_issues": 10, "misappropriation_amount": 5.0,
            "financial_deviation_issues": 8, "financial_deviation_amount": 3.5,
            "process_violation_issues": 12, "process_violation_amount": 4.0,
            "grievances_issues": 5, "grievances_amount": 1.5,
            "total_issues": 35, "total_amount": 14.0,
            "source_url": "nrega.nic.in", "scraped_at": "2026-01-01T00:00:00",
        }]
...
class TestMGNREGAFinancialStatement:
    def test_round_trip(self, db):
        records = [{
            "district": "PATNA", "state": "BIHAR", "state_code": "05",
            "col_2_num": 100.0, "col_3_num": 200.0, "col_5_num": 50.0,
            "col_6_num": 30.0, "col_7_num": 10.0, "col_9_num": 390.0,
            "col_10_num": 150.0, "col_11_num": 50.0, "col_12_num": 80.0,
            "col_13_num": 20.0, "col_14_num": 15.0, "col_15_num": 5.0,
            "col_16_num": 20.0, "col_17_num": 320.0, "col_18_num": 82.05,
            "col_19_num": 70.0,
            "source_url": "nrega.nic.in", "scraped_at": "2026-01-01T00:00:00",
        }]
...
class TestPMGSYProgress:
    def test_round_trip(self, db):
        records = [{
            ...
            "roads_completed": 120, "length_completed_km": 450.5,
            "habitations_connected": 80,
            "expenditure_programme_cr": 250.0, "expenditure_admin_cr": 12.5,
            "source_url": "pmgsy.dord.gov.in", "scraped_at": "2026-01-01T00:00:00",
        }]
...
class TestPMGSYDistrict:
    def test_round_trip(self, db):
        records = [{
            "district": "PATNA", "state": "BIHAR", "state_code": "05",
            "scheme": "PMGSY-I",
            "roads_sanctioned": 50, "roads_completed": 40,
            "length_sanctioned_km": 100.0, "length_completed_km": 80.0,
            "habitations_covered": 20,
            "value_of_projects_cr": 10.0, "expenditure_cr": 8.0,
            "source_url": "pmgsy.dord.gov.in", "scraped_at": "2026-01-01T00:00:00",
        }]
...
class TestPMAYG:
    def test_round_trip(self, db):
        records = [{
            ...
            "houses_occupied": 1200, "funds_released_lakhs": 5000.0,
            "funds_utilized_lakhs": 3500.0, "completion_pct": 75.0,
            "source_url": "pmayg.dord.gov.in", "scraped_at": "2026-01-01T00:00:00",
        }]
...
class TestPMKisan:
    def test_round_trip(self, db):
        records = [{
            ...
            "amount_paid_lakhs": 900.0, "beneficiaries_rejected": 1000,
            "installment": "17th",
            "source_url": "data.gov.in", "scraped_at": "2026-01-01T00:00:00",
        }]
    ...
    def test_field_name_mismatch_detected(self, db):
        ...
        records = [{
            ...
            "amount_paid_cr": 9.0,
            "installment": "17th",
            "source_url": "test", "scraped_at": "2026-01-01T00:00:00",
        }]
        count, rows = _load_and_query(db, load_pmkisan_district, "pmkisan_district", records)
        assert count == 1
        r = rows[0]
...
class TestJJM:
    def test_round_trip(self, db):
        records = [{
            ...
            "funds_released_lakhs": 3000.0, "funds_utilized_lakhs": 2100.0,
            "source_url": "ejalshakti.gov.in", "scraped_at": "2026-01-01T00:00:00",
        }]
...
class TestPMPOSHAN:
    def test_round_trip(self, db):
        records = [{
            ...
            "children_fed": 22000, "funds_released_lakhs": 1200.0,
            "funds_utilized_lakhs": 1000.0, "utilization_pct": 83.3,
            "source_url": "pmposhan-ams.education.gov.in", "scraped_at": "2026-01-01T00:00:00",
        }]
    ...
    def test_field_name_mismatch_detected(self, db):
        ...
        records = [{
            "district": "PATNA", "state": "BIHAR", "state_code": "05",
            "total_schools": 500, "student_enrolment": 25000,
            "meals_served": 22000, "meals_served_pct": 83.3,
            "source_url": "test", "scraped_at": "2026-01-01T00:00:00",
        }]
        count, rows = _load_and_query(db, load_pmposhan_district, "pmposhan_district", records)
        assert count == 1
...
class TestNSAP:
    def test_round_trip(self, db):
        records = [{
            ...
            "beneficiaries_paid": 7500, "amount_paid_lakhs": 450.0,
            "pension_per_month": 500.0,
            "source_url": "nsap.nic.in", "scraped_at": "2026-01-01T00:00:00",
        }]
...
class TestNFSA:
    def test_round_trip(self, db):
        records = [{
            ...
            "allocation_mt": 5000.0, "offtake_mt": 4200.0, "offtake_pct": 84.0,
            "beneficiaries_total": 300000,
            "source_url": "nfsa.gov.in", "scraped_at": "2026-01-01T00:00:00",
        }]
