...
def save_curated(records: list[dict[str, Any]]) -> Path:
    # Distinct filename: pmayg_finance_all_latest.json belongs to the richer
    # portal scrape (7 fin-years, 32 states). This data.gov.in resource stops
    # at FY2021-22 and overwrote it once — never let the two contend again.
    # No loader globs this name; the file is a reference artifact only.
    path = CURATED_DIR / "pmayg_dashboard_finance_all_latest.json"
